...
import { showInfoToast } from '../../../components/Atomic/Toast'
...
export const deviceStatusListener = async ({ deviceMetadataUpdated, deviceRegistered, deviceUnregistered, store }) => {
    if (deviceMetadataUpdated || deviceRegistered || deviceUnregistered) {
        ...
        setTimeout(
            async () => {
                const { deviceId, status: { value: deviceStatus } = {}, shadowSynchronization } = deviceMetadataUpdated || {}
