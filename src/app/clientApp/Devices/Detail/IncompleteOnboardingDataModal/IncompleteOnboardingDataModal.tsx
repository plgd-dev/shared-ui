...
import { Props, defaultProps, onboardingDataDefault, CopyDataType, OnboardingDataType } from './IncompleteOnboardingDataModal.types'
...
import * as copyStyles from '../../../../../components/Atomic/CopyElement/CopyElement.styles'
...
const ALLOWED_ATTRIBUTES = ['hubId', 'deviceEndpoint', 'authorizationCode', 'authorizationProvider', 'certificateAuthorities']
...
const IncompleteOnboardingDataModal: FC<Props> = (props) => {
            ...
            <div>
                ...
                <div css={styles.row}>
                    <FormGroup inline id='form-group-device-id' inlineJustifyContent='space-between'>
                        ...
                        <FormInput copy={true} disabled={true} inputWrapperStyle={styles.inputWrapper} value={deviceId} />
                    </FormGroup>
                </div>
                <div css={styles.row}>
                    <FormGroup inline error={!isValidUUID(onboardingData.hubId || '')} id='form-group-hubid' inlineJustifyContent='space-between'>
                ...
                <div css={styles.row}>
                    <FormGroup inline error={onboardingData.deviceEndpoint === ''} id='form-group-coapGatewayAddress' inlineJustifyContent='space-between'>
                ...
                <div css={styles.row}>
                    <FormGroup inline error={onboardingData.authorizationCode === ''} id='form-group-authorizationCode' inlineJustifyContent='space-between'>
    ...
    const hasError = useMemo(() => {
        const { deviceEndpoint, authorizationProvider, hubId, authorizationCode, certificateAuthorities } = onboardingData

        return !deviceEndpoint || !authorizationProvider || !hubId || !isValidUUID(hubId) || !authorizationCode || !certificateAuthorities
    }, [onboardingData])
