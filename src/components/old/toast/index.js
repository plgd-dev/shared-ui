...
import { isBrowserTabActive, playFartSound, loadFartSound } from '../../../common/utils'
import {
    toastTypes,
...
export const ToastContainer = () => {
    return (
        <Toastr
            closeButton={({ closeToast }) => <i onClick={closeToast} className='fas fa-times close-toast' />}
...
export const showToast = (message, options = {}, type = ERROR) => {
    ...
    if (isBrowserTabActive() && dispatchedToasts < MAX_NUMBER_OF_ALL_TOASTS) {
        ...
        const renderToast = <ToastComponent message={toastMessage} title={toastTitle} type={type} />
...
export const showErrorToast = (message, options = {}) => showToast(message, options, ERROR)
export const showSuccessToast = (message, options = {}) => showToast(message, options, SUCCESS)
export const showInfoToast = (message, options = {}) => showToast(message, options, INFO)
export const showWarningToast = (message, options = {}) => showToast(message, options, WARNING)
